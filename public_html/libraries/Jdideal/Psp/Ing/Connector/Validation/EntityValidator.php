	...
	public function validate($request)
	{
		...
		else
		{
			...
			else
			{
				...
				{
					if ($className === "iDEALConnector\Entities\DirectoryResponse")
					{
					...
					{
						if ($className === "iDEALConnector\Entities\AcquirerTransactionResponse")
						{
						...
						{
							if ($className === "iDEALConnector\Entities\AcquirerStatusResponse")
							{
