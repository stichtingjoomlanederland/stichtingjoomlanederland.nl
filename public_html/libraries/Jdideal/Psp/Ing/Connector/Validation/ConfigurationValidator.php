...
class ConfigurationValidator
{
	...
	public static function getConfigFileStatus($path)
	{
		...
		$errors = array(
			...
			'PRIVATEKEYPASS'    => self::getCertificatePrivateKeyStatus($conf->getCertificatePath(),
				$conf->getPrivateKeyPath(), $conf->getPassphrase()),
			'PRIVATECERT'       => self::checkFile($conf->getCertificatePath())
				. self::getCertificateStatus($conf->getCertificatePath()),
