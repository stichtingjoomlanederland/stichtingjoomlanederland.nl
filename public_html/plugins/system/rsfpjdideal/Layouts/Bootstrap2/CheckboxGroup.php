...
namespace Ropayments\Rsformpro\Layouts\Bootstrap2;

defined('_JEXEC') or die;

use Ropayments\Rsformpro\Layouts\CheckboxTrait;
use RSFormProFieldBootstrap2CheckboxGroup;
 ...
 * @since    6.6.0
 */
class CheckboxGroup extends RSFormProFieldBootstrap2CheckboxGroup
{
	use CheckboxTrait;
