...
namespace Ropayments\Rsformpro\Layouts\Bootstrap3;

defined('_JEXEC') or die;

use Ropayments\Rsformpro\Layouts\CheckboxTrait;
use RSFormProFieldBootstrap3CheckboxGroup;
 ...
 * @since    6.6.0
 */
class CheckboxGroup extends RSFormProFieldBootstrap3CheckboxGroup
{
	use CheckboxTrait;
