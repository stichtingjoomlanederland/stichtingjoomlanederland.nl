...
namespace Ropayments\Rsformpro\Layouts\Bootstrap4;

defined('_JEXEC') or die;

use Ropayments\Rsformpro\Layouts\CheckboxTrait;
use RSFormProFieldBootstrap4CheckboxGroup;
 ...
 * @since    6.6.0
 */
class CheckboxGroup extends RSFormProFieldBootstrap4CheckboxGroup
{
	use CheckboxTrait;
