...
namespace Ropayments\Rsformpro\Layouts\Foundation;

defined('_JEXEC') or die;

use Ropayments\Rsformpro\Layouts\CheckboxTrait;
use RSFormProFieldFoundationCheckboxGroup;
 ...
 * @since    6.6.0
 */
class CheckboxGroup extends RSFormProFieldFoundationCheckboxGroup
{
	use CheckboxTrait;
