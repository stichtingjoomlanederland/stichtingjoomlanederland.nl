...
if (JVERSION >= 4)
{
	foreach ($this->pspForm->getFieldset('sisow') as $field) {
...
?>
<div class="span10">
	<?php foreach ($this->pspForm->getFieldset('sisow') as $field) : ?>
...
<div class="span2">
	<table class="table table-striped">
		...
		<tbody>
			<tr>
				<td class="center"><?php echo HTMLHelper::_('link', 'http://www.sisow.nl/', HTMLHelper::_('image','com_jdidealgateway/sisow.png', 'Sisow', false, true), 'target="_new"'); ?></td>
				<td></td>
			</tr>
		</tbody>
	</table>
