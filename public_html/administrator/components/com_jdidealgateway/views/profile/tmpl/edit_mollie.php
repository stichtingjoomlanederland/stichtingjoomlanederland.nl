...
if (JVERSION >= 4)
{
	foreach ($this->pspForm->getFieldset('mollie') as $field) {
...
?>
<div class="span10">
	<?php foreach ($this->pspForm->getFieldset('mollie') as $field) : ?>
...
<div class="span2">
	<table class="table table-striped">
		...
		<tbody>
			<tr>
				<td class="center"><?php echo HTMLHelper::_('link', 'https://www.mollie.nl/login', HTMLHelper::_('image', 'com_jdidealgateway/mollie.jpg', 'Mollie', false, true), 'target="_new"'); ?></td>
				<td></td>
			</tr>
		</tbody>
	</table>
