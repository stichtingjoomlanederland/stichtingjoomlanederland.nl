...
if (JVERSION >= 4)
{
	foreach ($this->pspForm->getFieldset('ems') as $field) {
...
?>
<div class="span10">
	<?php echo $this->pspForm->renderFieldset('ems'); ?>
</div>
<div class="span2">
	<table class="table table-striped">
		...
		<tbody>
			<tr>
				<td class="center"><?php echo HTMLHelper::_('link', 'https://www.ipg-online.com/vt/login', HTMLHelper::_('image', 'com_jdidealgateway/ems.jpg', 'EMS', false, true), 'target="_new"'); ?></td>
				<td class="center"></td>
			</tr>
		</tbody>
	</table>
