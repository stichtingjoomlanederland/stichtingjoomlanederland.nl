...
if (JVERSION >= 4)
{
	foreach ($this->pspForm->getFieldset('onlinekassa') as $field) {
...
?>
<div class="span10">
	<?php foreach ($this->pspForm->getFieldset('onlinekassa') as $field) : ?>
		<?php if ($field->getAttribute('name') === 'paymentMeanBrandList') : ?>
