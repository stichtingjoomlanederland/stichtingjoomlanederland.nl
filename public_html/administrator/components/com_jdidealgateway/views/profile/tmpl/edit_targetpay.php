...
if (JVERSION >= 4)
{
	foreach ($this->pspForm->getFieldset('targetpay') as $field) {
...
?>
<div class="span10">
	<?php foreach ($this->pspForm->getFieldset('targetpay') as $field) : ?>
...
<div class="span2">
	<table class="table table-striped">
		...
		<thead>
			<tr>
				<th>
					<?php echo Text::_('COM_ROPAYMENTS_PRODUCTION_DASHBOARD'); ?>
				</th>
				<th>
					<?php echo Text::_('COM_ROPAYMENTS_TEST_DASHBOARD'); ?>
				</th>
			</tr>
		</thead>
				...
				<td class="center">
					<?php
						echo HTMLHelper::_(
							...
							HTMLHelper::_('image', 'com_jdidealgateway/targetpay.png', 'Target Pay', false, true),
							'target="_new"'
						);
					?>
				</td>
