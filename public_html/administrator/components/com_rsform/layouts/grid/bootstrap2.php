...
class RSFormProGridBootstrap2 extends RSFormProGrid
{
	...
	protected function generateField($data)
	{
		...
		if ($data->ComponentTypeId == RSFORM_FIELD_FREETEXT)
		{
			...
			$html[] = "\t"."\t"."\t".'<div class="control-group rsform-block rsform-block-' . $block . ' rsform-type-' . $type . $placeholders['error'] . '">';
		...
		else
		{
			...
			$html[] = "\t"."\t"."\t".'<div class="control-group rsform-block rsform-block-' . $block . ' rsform-type-' . $type . $placeholders['error'] . '">';
				...
				$html[] = "\t"."\t"."\t"."\t".'<div ' . $this->fieldAttributes($data) . '>';
					...
					{
						$html[]	= "\t"."\t"."\t"."\t"."\t".'<span class="help-block formValidation">' . $placeholders['validation'] . '</span>';
					}
				$html[] = "\t"."\t"."\t"."\t".'</div>';
			$html[] = "\t"."\t"."\t".'</div>';
		}
