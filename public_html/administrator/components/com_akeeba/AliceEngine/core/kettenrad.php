 ...
 */
if ( !function_exists('deadOnTimeOutAlice'))
{
	function deadOnTimeOutAlice()
	{
		...
		{
			AliceUtilLogger::WriteLog(_AE_LOG_ERROR, \Akeeba\Engine\Platform::getInstance()
																			->translate('COM_AKEEBA_BACKUP_ERR_KETTENRAD_TIMEOUT'));
		}
	}

	register_shutdown_function("deadOnTimeOutAlice");
}
