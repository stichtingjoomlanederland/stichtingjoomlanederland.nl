...
class Sugarsync
{
	...
	private $userAgent = 'AkeebaEngine/';
	...
	public function __construct($config = array())
	{
		...
		$this->userAgent .= defined('AKEEBABACKUP_VERSION') ? AKEEBABACKUP_VERSION : AKEEBA_VERSION;
	}
	 ...
	 * @param string|null $localFile Full path to the local file to write the data. If null, the raw file data will be
	 ...
	 * @throws SugarsyncException
	 */
	protected function  apiCall($descriptor = array())
	{
		...
		$heads = array_key_exists('headers', $descriptor) ? $descriptor['headers'] : array();
		...
		{
			throw new SugarsyncException("HTTP Error [$http_code]: The credentials were rejected by SugarSync. Check your email and password.");
		}
