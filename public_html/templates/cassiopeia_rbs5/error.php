...
?>">
	<header class="header container-header full-width">
		...
		<?php endif; ?>
		<?php // -------- Custom error header positions -------- ?>
			<?php echo Joomla\CMS\Layout\LayoutHelper::render(
				'rbs5theme.'.$this->params->get('themeNavigation', 'nav-offcanvas'), array('params' => $this->params)); ?>

			<?php if ($this->countModules('error-top', true)) : ?>
			<div class="container-rbs5-top full-width">
				<div class="rbs5-header">
					<div class="container-fluid container-xxl">
						<div class="row header">
							<jdoc:include type="modules" name="error-top" style="rbs5-noCard" />
						</div>
					</div>
				</div>
			</div>
